...
import it.aulab.progettofinale.services.CareerRequestService;
...
public class OperationController {
    ...
    //rotta per creazione di una richiesta di collaborazione
    ...
    public String careerRequestCreate(Model viewModel){
        ...
        //  Elimino la possibilità di selezionare il ruolo di user nella select del form
    ...
    public String careerRequestStore(@ModelAttribute("careerRequest") CareerRequest careerRequest, Principal principal, RedirectAttributes redirectAttributes) {
        ...
        if(careerRequestService.isRoleAlreadyAssigned(user, careerRequest)) {
            redirectAttributes.addFlashAttribute("errorMessage", "Hai già questo ruolo!");
            return "redirect:/";
        }
      
        careerRequestService.save(careerRequest, user);
        
        redirectAttributes.addFlashAttribute("successMessage", "Richiesta di collaborazione inviata con successo!");
        return "redirect:/";
    }
